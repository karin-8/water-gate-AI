...
def simulate_gates_over_time(q0, h, initial_ys=[11, 10, 9, 8, 7], Cds=[0.6]*5, gate_width=10.0, length=5.0, dt=10, steps=360):
    import numpy as np
...
def optimize_gate_openings(q0=100):
    bounds = [(0.1, 2)] * 5  # h1 to h4 between 0% and 100%
    initial_guess = [0.5] * 5
